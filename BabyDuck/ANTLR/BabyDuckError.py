class BabyDuckError(Exception):
    ...
    def __init__(self, phase, subsection=None):
        ...
        |______|_|  \_\_|  \_\\____/|_|  \_\ |______|_| \_|   
         ...
         _____ _____ _____  ______ _____ _____ _____ ____  _   _ ______  _____ 
        |  __ \_   _|  __ \|  ____/ ____/ ____|_   _/ __ \| \ | |  ____|/ ____|
        | |  | || | | |__) | |__ | |   | |      | || |  | |  \| | |__  | (___  
        | |  | || | |  _  /|  __|| |   | |      | || |  | | . ` |  __|  \___ \ 
        | |__| || |_| | \ \| |___| |___| |____ _| || |__| | |\  | |____ ____) |
        |_____/_____|_|  \_\______\_____\_____|_____\____/|_| \_|______|_____/          

         __      _______ _____ _______ _    _         _      ______  _____ 
         \ \    / /_   _|  __ \__   __| |  | |  /\   | |    |  ____|/ ____|
          \ \  / /  | | | |__) | | |  | |  | | /  \  | |    | |__  | (___  
           \ \/ /   | | |  _  /  | |  | |  | |/ /\ \ | |    |  __|  \___ \ 
            \  /   _| |_| | \ \  | |  | |__| / ____ \| |____| |____ ____) |
             \/   |_____|_|  \_\ |_|   \____/_/    \_\______|______|_____/           
        """
        ...
        self.phases = {
            ...
            "direcciones virtuales": self.memory_manager_error,
            "vm": self.vm_error
        }
