...
class BabyDuckListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by BabyDuckParser#devuelve.
    def enterDevuelve(self, ctx:BabyDuckParser.DevuelveContext):
        pass

    # Exit a parse tree produced by BabyDuckParser#devuelve.
    def exitDevuelve(self, ctx:BabyDuckParser.DevuelveContext):
        pass
